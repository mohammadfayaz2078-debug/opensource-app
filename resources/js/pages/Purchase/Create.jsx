...
export default function PurchaseCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      else setErrors({ general: err.response?.data?.message || 'Failed to create purchase.' });
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-4">
        ...
        <h1 className="text-xl font-semibold text-gray-900 mt-1">New Purchase Order</h1>
      </div>
          ...
          <div className="p-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div>
                ...
                <input name="reference_no" value={form.reference_no} onChange={e => setForm({ ...form, reference_no: e.target.value })} className={inputClass} placeholder="Supplier invoice #" />
              </div>
            </div>
          </div>
        </div>
