    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-sm text-gray-500">Loading purchase details...</span>
        </div>
      </div>
    );
  }
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 bg-gray-50/50 flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <span className="text-xs text-gray-500">{purchase.items?.length || 0} items</span>
                {purchase.refund_status === 'full' && (
                  ...
                  <tfoot>
                    <tr className="border-t-2 border-gray-200 bg-gray-50/50">
                      ...
                      <td colSpan="3" className="py-3 px-4 text-right text-xs text-gray-500">
                        {purchase.items?.filter(item => item.refund_status === 'full').length} fully refunded items
                      </td>
                    </tr>
                  </tfoot>
                )}
          ...
          {purchase.returns?.length > 0 && (
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200 bg-gray-50/50 flex items-center justify-between">
                ...
                <span className="text-xs text-gray-500">{purchase.returns.length} returns</span>
              </div>
                ...
                {purchase.returns.map(ret => (
                  <div key={ret.id} className="flex justify-between items-center p-3 bg-red-50/50 rounded-lg border border-red-100 hover:bg-red-50 transition-colors">
                    <div>
                      ...
                      {ret.reason && (
                        <span className="text-xs text-gray-400 ml-3">Reason: {ret.reason}</span>
                      )}
                    </div>
