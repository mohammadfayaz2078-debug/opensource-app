...
export default function UnitCategoryShow() {
  ...
  const getMeasureTypeLabel = (type) => {
    const labels = {
      unit: 'Unit (Pieces, Each, etc.)',
      weight: 'Weight (kg, g, lb, etc.)',
      volume: 'Volume (L, mL, gal, etc.)',
      length: 'Length (m, cm, ft, etc.)',
      time: 'Time (days, hours, etc.)'
    };
    ...
    <div>
        ...
        <div className="flex justify-between items-start">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Unit Category</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-lg font-medium text-gray-900">Units in this Category</h2>
            </div>
            <div className="p-6">
              {category.units && category.units.length > 0 ? (
                  ...
                  <table className="min-w-full">
                    <thead>
                      <tr className="bg-gray-50">
                        <th className="px-3 py-2 text-left text-xs font-medium text-gray-500">Unit Name</th>
                        <th className="px-3 py-2 text-left text-xs font-medium text-gray-500">Symbol</th>
                        <th className="px-3 py-2 text-left text-xs font-medium text-gray-500">Conversion Factor</th>
                      </tr>
                    </thead>
                    <tbody>
                ...
                <div className="text-center py-8">
                  <p className="text-sm text-gray-500">No units have been added to this category yet.</p>
                  <button
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-lg font-medium text-gray-900">Measure Type</h2>
            </div>
            <div className="p-6">
