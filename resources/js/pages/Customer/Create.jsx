                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="0.00"
                    />
                    {errors.opening_balance && <p className="text-red-500 text-xs mt-1">{errors.opening_balance[0]}</p>}
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">
                      Balance Type
                    ...
                    {errors.opening_balance_type && <p className="text-red-500 text-xs mt-1">{errors.opening_balance_type[0]}</p>}
                    <p className="text-xs text-gray-400 mt-1">
                      Debit: Customer owes you money (typical). Credit: You owe the customer.
                    </p>
                  </div>
                </div>
              </div>
