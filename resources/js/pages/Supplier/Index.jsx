                ...
                {filtered.map((supplier, idx) => (
                  <tr key={supplier.id} className={`border-t border-gray-100 ${idx % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'} hover:bg-blue-50/50 transition-colors`}>
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          {supplier.contact_person && (
                            <p className="text-[11px] text-gray-700">{supplier.contact_person}</p>
                          )}
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-2.5 text-sm text-gray-700">
                      ...
                      <div className="text-[11px] text-gray-700">{supplier.email || ''}</div>
                    </td>
                    ...
                    <td className="px-4 py-2.5 whitespace-nowrap text-center">
                      <button
                        ...
                        className={`inline-flex items-center px-2 py-0.5 rounded text-[11px] font-medium ${
                          supplier.is_active ? 'bg-emerald-50 text-emerald-600' : 'bg-gray-100 text-gray-700'
                        }`}
                      >
