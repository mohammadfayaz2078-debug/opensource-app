      ...
      <div ref={receiptRef} className="max-w-2xl mx-auto px-4">
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden print:shadow-none print:border-none print:rounded-none">
          ...
          <div className="p-6 space-y-5">
            ...
            {/* Invoice Info */}
            <div className="border-b border-gray-100 pb-4">
              <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Invoice Information</h2>
            ...
            {/* Account Info */}
            <div className="border-b border-gray-100 pb-4">
              <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Payment Received In</h2>
