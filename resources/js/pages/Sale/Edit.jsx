...
export default function SaleEdit() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-4">
        <button onClick={() => navigate(`/sales/${id}`)} className="text-sm text-[#007c89] hover:underline">&larr; Back</button>
        <h1 className="text-xl font-semibold text-gray-900 mt-1">Edit Invoice</h1>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm mb-4">
          <div className="px-4 py-3 border-b border-gray-200"><h2 className="text-sm font-semibold text-gray-900">Invoice Details</h2></div>
          <div className="p-4">
