...
const CompanyEdit = () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setForm({
          ...
          email: company.email || '', // Manager email
          manager_password: '',
          manager_password_confirmation: '',
      ...
      const errorMsg = err.response?.data?.message || 'Failed to load company data';
      setError(errorMsg);
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const response = await api.post(`/super-admin/companies/${id}`, formData, {
        headers: {
      ...
      <div className="flex justify-center min-h-screen px-4 py-6 bg-gray-50">
        <div className="w-full max-w-5xl bg-white rounded-lg shadow-sm">
          <div className="text-center py-12">
            ...
            <p className="mt-3 text-sm text-gray-600">Loading company data...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="flex justify-center min-h-screen px-4 py-6 bg-gray-50">
      <div className="w-full max-w-5xl bg-white rounded-lg shadow-sm">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <h1 className="text-lg font-semibold text-gray-900">Edit Company</h1>
          <Link
        ...
        <form onSubmit={submit} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Manager Password (Optional on edit) */}
            <div>
              <label className="block mb-2 text-sm font-medium text-gray-700">
                Manager Password
              ...
              <div className="flex items-center space-x-4">
                ...
                {currentLogo && !logoPreview && (
                  <div className="relative">
                    ...
                    />
                    <span className="absolute -top-2 -left-2 text-xs bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded">Current</span>
                  </div>
                )}
