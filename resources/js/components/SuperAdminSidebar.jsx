          ...
          <div className="mt-3 flex-shrink-0">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 bg-white/10 text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[#3FA7FF] focus:bg-white/15 text-sm border border-white/10"
              />
            </div>
          </div>
        )}
